...
<emfta:FTAModel xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:emfta="http://cmu.edu/emfta" root="//@events.7" name="nestedcomposite_main_nestedstate-failstop" description="Top Level Failure">
  <events name="sensor1-failure" description="Error event Failure on component sensor1" referenceCount="1"/>
  <events name="sensor2-failure" description="Error event Failure on component sensor2" referenceCount="1"/>
  ...
  <events name="voter.thr1-failure" description="Error event Failure on component thr1" referenceCount="1"/>
  <events name="voter.thr2-failure" description="Error event Failure on component thr2" referenceCount="1"/>
